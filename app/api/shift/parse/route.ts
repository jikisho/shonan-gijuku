...
スロット（1時間単位）: s08=8時, s09=9時, s10=10時, s11=11時, s12=12時, s13=13時, s14=14時, s15=15時, s16=16時, s17=17時, s18=18時, s19=19時, s20=20時, s21=21時, s22=22時

例: 「10日の18時から21時まで可能」→ 10日が水曜なら day_index=2, slot_key=s18/s19/s20
例: 「火曜の午後全部」→ day_index=1, slot_key=s13〜s22まで全部
